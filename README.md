# SOV Admin v1.4.14.8 — Map tracking controls

Novo u ovoj verziji:
- Tracking kontrola je prebačena iz Izleta na Kartu → Team.
- U Izletima ostaje samo formiranje teama i pridruživanje kodom.
- Na karti, u Team bottom sheetu, odabereš team i možeš pokrenuti Lite ping ili Ruta/GPX, prekinuti tracking i syncati queue.
- Field Tracking i dalje prvo sprema lokalno, pa synca u batchu.
- Ne treba novi SQL ako je već pokrenut Field Tracking SQL v5.59.4.
...
Settings diagnostic icons: Baterija, GPS, Mreža, Kompas and Moja baza each open a dedicated screen. No SQL required.


## SOV Admin 1.4.14.9 — Trip Cloud Assets

- dodana sekcija **Paketi za teren** na cloud izletima
- app može objaviti `.sovpkg` paket izleta u Supabase Storage bucket `sov-trip-assets`
- paket može uključivati offline kartu, trackove/GPX/KML i TopoDroid privitke
- članovi mogu kliknuti **Skini i otvori** i lokalno importirati paket
- traži SQL `SUPABASE_SOV_TRIP_ASSETS_v5_59_6.sql`
