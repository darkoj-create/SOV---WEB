...
-- Drop first because CREATE OR REPLACE VIEW cannot change an existing column type
-- such as profiles.status enum -> text. This drops only the view, not data tables.
