 ...
 * Active stack: core + TopoDroid parser fix + renderer v2 + official branding + semantic SVG modules + corpus style v6 + corrected PDS logo + non-destructive editor + cloud persistence bridge + node geometry overrides.
 */
