-- SOV Arhivar v5.57.4 — TIMEOUT FIX / split list vs detail
...
with base as (
  ...
  select
    ...
    (
      b.status_text_norm ~ '((fali|nedostaje|nema|bez|treba|trebaju|potrebno|srediti|napraviti|dopuniti|prikupiti|pronaci|naci).{0,80}(zapisnik|tzapisnik|izvjestaj|izvještaj|bibliograf))'
