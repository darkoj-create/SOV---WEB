...
(function(){
  'use strict';
  const FALLBACK_VERSION='6.1.43d';
  const FALLBACK_CACHE='6143d-gmail-sync-complete';
  const FALLBACK_BUILD='sov-web-build-v6.1.43d-gmail-sync-complete';
  const FALLBACK_NAME='v6.1.43d-gmail-sync-complete';
