// SOV Web 6.1.11 — safe frontend version helper.
...
(function(){
  'use strict';
  const FALLBACK_VERSION='6.1.11';
  const FALLBACK_CACHE='6111';
  const FALLBACK_BUILD='sov-web-build-v6.1.11-documents-full-archive-ready';
  const FALLBACK_NAME='v6.1.11-documents-full-archive-ready';
