...
(function(){
  'use strict';
  const FALLBACK_VERSION='6.1.45al';
  const FALLBACK_CACHE='6145al-nacrt-renderer-v2';
  const FALLBACK_BUILD='sov-web-build-v6.1.45al-nacrt-renderer-v2';
  const FALLBACK_NAME='v6.1.45al-nacrt-renderer-v2';
