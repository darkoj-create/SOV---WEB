...
(function(){
  'use strict';
  const FALLBACK_VERSION='6.1.43b';
  const FALLBACK_CACHE='6143b-gmail-sync-28d';
  const FALLBACK_BUILD='sov-web-build-v6.1.43b-manual-gmail-sync-28d';
  const FALLBACK_NAME='v6.1.43b-manual-gmail-sync-28d';
