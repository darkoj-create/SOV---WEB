// SOV Web 6.1.18 — safe frontend version helper.
...
(function(){
  'use strict';
  const FALLBACK_VERSION='6.1.18';
  const FALLBACK_CACHE='6117';
  const FALLBACK_BUILD='sov-web-build-v6.1.18-trip-delete-hard-fix';
  const FALLBACK_NAME='v6.1.18-trip-delete-hard-fix';
