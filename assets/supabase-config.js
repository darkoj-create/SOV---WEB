...
// v4.92 Nacrti sync
// Opcija A (preporučeno): deployaj GOOGLE_APPS_SCRIPT_NACRTI_SYNC_v4_92.gs kao Web App i ovdje zalijepi /exec URL.
window.SOV_DRAWINGS_SYNC_ENDPOINT = window.SOV_DRAWINGS_SYNC_ENDPOINT || '';
