(function(){
  ...
  function install(){
    ...
    const wrapped=async function(options){
      ...
      // Inventar mora gledati isti kanonski/grupirani katalog kao katalog za posuđivanje.
      // Master renderer inače automatski prelazi na raw_app_catalog, što stvara druge
      // nazive, duplikate i količine. Inventura i ostali master ekrani ostaju netaknuti.
      return {
        ...data,
