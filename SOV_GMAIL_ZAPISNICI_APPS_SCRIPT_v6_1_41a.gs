/**
 * SOV Gmail -> Zapisnici sastanaka auto-import v6.1.41a
 *
 * Kako koristiti:
 ...
 *    Trigger se instalira samo za srijedu oko 23:50.
...
function installSovGmailZapisniciTrigger() {
  ...
  ScriptApp.newTrigger('processSovGmailZapisnici')
    ...
    .everyWeeks(1)
    .create();
  Logger.log('SOV Gmail zapisnici trigger installed: Wednesdays around 23:50.');
}
