-- SOV Field Tracking Lite v5.59.3
-- Trip + team selector support for web tracking.html
-- Run after v5.59.2.
...
-- Keep sync-status compatible, but add field event count for v5.59.3.
create or replace view public.sov_tracking_sync_status as
select
  'sov_field_tracking_lite_v5_59_3'::text as module,
