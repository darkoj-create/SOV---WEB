-- SOV Arhivar v5.57.6 — ARHIVAR.HTML REAL DETAIL UI + FULL SQL ROW FIX / split list vs detail
...
-- v5.57.6 dodatno: detail RPC vraća cijeli SQL row kroz to_jsonb(s), ne samo raw JSON; UI jasno vidi sva SQL polja.
