...
3. Zalijepi sadržaj filea `SOV_GMAIL_ZAPISNICI_APPS_SCRIPT_v6_1_41a.gs`.
...
## Trigger cadence v6.1.41a

`installSovGmailZapisniciTrigger()` sada briše stare `processSovGmailZapisnici` triggere i instalira samo jedan weekly trigger:
...
Napomena: Google Apps Script time trigger nije sekundno-egzaktan; `nearMinute(50)` znači oko 23:50 u timezoneu Apps Script projekta. Postavi project timezone na Europe/Zagreb.
