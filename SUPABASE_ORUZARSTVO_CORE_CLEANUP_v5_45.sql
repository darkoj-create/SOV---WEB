...
-- v5.45 smoke checks:
-- select main_category, count(*) from public.sov_equipment_app_catalog_grouped group by main_category order by min(priority), main_category;
-- select public.sov_armory_request_status_ui('approved'); -- pending
